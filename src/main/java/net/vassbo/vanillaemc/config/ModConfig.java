...
public class ModConfig {
    ...
    private static void createConfigs() {
        ...
        configs.addKeyValuePair(new Pair<>("private_emc", false), "Should each player have their own EMC storage? (Note: Turning this on will disable redstone integration.)");
